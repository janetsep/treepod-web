...
const SEASONS = [
    ...
    },
    {
        ...
        icon: Leaf,
        title: "Paleta Dorada",
        description: "El bosque nativo se transforma. Es la época ideal para el silencio y la contemplación desde la terraza exclusiva elevada.",
    ...
    },
    {
        ...
        description: "A diferencia de las construcciones tradicionales, el domo permite una circulación de aire constante. Sombra natural y noches frescas garantizadas.",
