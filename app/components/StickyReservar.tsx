  ...
  return (
    ...
    >
      <div className="mx-3 mb-3 rounded-2xl bg-white/95 backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,0.18)] border border-black/5 px-4 py-3 flex items-center justify-between gap-3">
        ...
        <Link
          href="/disponibilidad"
          className="shrink-0 inline-flex items-center gap-1.5 bg-[#4A7C2E] hover:bg-[#3A6122] text-white font-bold text-sm px-5 py-2.5 rounded-full shadow-md active:scale-95 transition-all"
        >
