  ...
  return (
    <section className="relative h-screen min-h-[700px] text-white overflow-hidden">
      ...
      <div className="absolute inset-0 bg-background-dark">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/20 to-black/90 md:from-black/50 md:via-transparent md:to-black/70 z-10"></div>
      </div>

      <div className="relative z-10 container mx-auto px-4 md:px-6 h-full flex flex-col justify-center items-center text-center pt-24 md:pt-32">
        ...
        <h1 className="h1-display mb-6 md:mb-10 drop-shadow-[0_10px_20px_rgba(0,0,0,1)] max-w-5xl animate-fade-in-up delay-100 !text-white leading-tight">
          <span className="!text-white">Refugio Geodésico</span><br />
          <span className="text-primary drop-shadow-[0_4px_12px_rgba(0,0,0,1)] italic block mt-3 !font-black">de Alta Montaña</span>
        </h1>
        ...
        <p className="text-lg md:text-2xl text-white/95 font-bold mb-12 md:mb-20 max-w-3xl leading-relaxed drop-shadow-[0_4px_10px_rgba(0,0,0,1)] animate-fade-in-up delay-200">
          Espacios de alta eficiencia térmica diseñados para tu autonomía.
          <br className="hidden md:block" />
          Vistas reales al bosque nativo de Las Trancas.
        </p>
        ...
        <div
          className="absolute bottom-28 md:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-90 cursor-pointer group hover:opacity-100 transition-opacity z-20"
          onClick={() => document.getElementById('domos')?.scrollIntoView({ behavior: 'smooth' })}
        >
          <span className="text-[10px] uppercase tracking-[0.3em] text-white font-bold group-hover:text-primary transition-colors animate-pulse">Explorar</span>
